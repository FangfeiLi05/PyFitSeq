...
def main():
    ...
    # -- read_num_average_seq: average number of reads per genotype per sequencing time-point, [0,r1,r2,...]
    ...
    csv_input = np.array(pd.read_csv(str(args.input), header=None), dtype=float)
    x = csv_input[:, 0]
